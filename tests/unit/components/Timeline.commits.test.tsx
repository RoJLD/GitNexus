...
const defaultAppState = {
  ...
  cursorA: null, cursorB: null, zoomWindow: null, timelineGraphMode: 'single',
  setCursorA: vi.fn(), setCursorB: vi.fn(), enterZoom: vi.fn(), exitZoom: vi.fn(), setTimelineGraphMode: vi.fn(),
