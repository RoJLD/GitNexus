...
**Compteurs (autogénérés)** : MCP tools = <!-- COUNTER:mcp-tools -->37<!-- /COUNTER --> · additive-files = <!-- COUNTER:additive-files -->143<!-- /COUNTER --> · inplace-files = <!-- COUNTER:inplace-files -->25<!-- /COUNTER -->.
