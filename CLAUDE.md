...
| `patches/additive-files.diff` | New files we own (136 files, zero conflict risk). Regenerated by hand, see below. |
...
├── patches/
│   ├── additive-files.diff     New files we own (~136 files, zero conflict risk at bump)
