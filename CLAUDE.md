...
| `patches/additive-files.diff` | New files we own (99 files, zero conflict risk). Regenerated by hand, see below. |
| `patches/inplace-edits.diff` | In-place edits to upstream files (17 files, the real conflict surface). Regenerated by hand, see below. |
