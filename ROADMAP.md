...
Dernière mise à jour : 2026-05-28 (Auto-reindexing du graphe livré (Tier 56) — 2e item de parité enterprise : cron détecte HEAD change → analyze incrémental, opt-in, GET /auto-reindex. Avant : Code Wiki UI (Tier 55). 2/8 items enterprise couverts (Code Wiki ✅, Auto-reindexing ✅).).
