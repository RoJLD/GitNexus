...
Dernière mise à jour : 2026-05-27 (Roadmap-predictive Augmented graph livré : toggle "Show ghosts" dans Filters, ghosts overlay sur Sigma — anchored à leurs `expectedLinks` matchés, satellite cluster top-right pour unmatched. Encoding par Tier + opacité time-decaying 4-niveaux, popup au click avec matched/unmatched + bouton "Open in ROADMAP.md". Pure frontend, zéro backend modifié).
