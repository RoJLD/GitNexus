...
Dernière mise à jour : 2026-05-26 (Roadmap-predictive CORE livré : `ROADMAP.md` parsé → `ghosts.json` sidecars, 3 endpoints `/ghosts/sync`, `/ghosts`, `/ghosts/at`, snapshot auto-sync, plugin-aware registry `registerGhostSource()` pré-câble Tier 3.10).
