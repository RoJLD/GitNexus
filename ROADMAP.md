...
Dernière mise à jour : 2026-05-28 (Timeline URL Persistence Phase 2 Item #5 livré : 5 params tl* shareable + restore au reload, shortHash-based. Reste 1 item Phase 2 : Zoom mousewheel (#4). Item #2 subsumed.).
