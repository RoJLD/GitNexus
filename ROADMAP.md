...
Dernière mise à jour : 2026-05-28 ("Auto" regression forensics livré (Tier 59) — webhooks watches enrichis du commit coupable au franchissement de seuil ; clôt l'item enterprise "Auto regression forensics" (on-demand Tiers 57-58 + auto). Avant : Regression Phase 2 (Tier 58), MVP (Tier 57), Auto-reindexing (Tier 56), Code Wiki UI (Tier 55). 3/8 items enterprise couverts (Code Wiki, Auto-reindexing, Regression forensics ✅).).
