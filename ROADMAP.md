...
| **P2** | **Boîte à outils théorie-des-graphes** | Centralités, communautés, chemins/cycles, points d'articulation, embeddings — exposés par graphe (endpoints + MCP + overlays). **Décomposé** en P2.1 + P2.2 + P2.3.1 + P2.3.2 (a+b+c, source ASTKG complète) — tous livrés — + P2.3.3 (surfaces, backlog). | 🚧 P2.1·P2.2·P2.3.1·P2.3.2(a/b/c) livrés · P2.3.3 backlog |
