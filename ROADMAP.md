...
Dernière mise à jour : 2026-05-27 (Roadmap-predictive Audit view livrée : `GET /ghost-audit` avec cache mtime-invalidé, 6 métriques agrégées + AuditPanel React avec 6 sous-composants. Update 2 placementAccuracy deferred — nécessite Leiden communities backend).
