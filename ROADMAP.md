...
Dernière mise à jour : 2026-05-28 (Code Wiki dans l'UI web + auto-update livré (Tier 55) — 1er item de parité enterprise : panel iframe + génération server-side via wiki-worker + auto-régen cron. Avant : Timeline Wheel Zoom (Tier 54) clôturait Phase 2 (5/5).).
