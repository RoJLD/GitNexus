...
Dernière mise à jour : 2026-05-27 (Timeline Temporal Filter Phase 2 Item #1 livré : dropdown 3 modes + backend `/nodes/alive-between` pour permissive. 4 items Phase 2 restants : Mode union dedié, Lifespan fenêtré, URL persistence, Zoom mousewheel).
